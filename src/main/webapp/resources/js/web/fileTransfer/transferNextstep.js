...
function initMethod(){
	...
	$("button.btn_hand").on("click",function(){
		...
		if(Util.checkNull(transferTitle)){
			layer.alert("请填写移交标题！", {skin: 'layui-layer-lan',closeBtn: 0});
			return;
		}
		
		if(typeof(companyData)=="undefined"){
			layer.alert("请选择移交公司！", {skin: 'layui-layer-lan',closeBtn: 0});
			return;
		}
		if(Util.checkNull(companyData.value)){
			layer.alert("请选择移交公司！", {skin: 'layui-layer-lan',closeBtn: 0});
			return;
		}
