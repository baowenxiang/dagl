...
GooFlow.prototype={
	...
	initDraw:function(id,width,height){
		...
		$(this.$draw).delegate(tmpClk,"dblclick",{inthis:this},function(e){
			...
			This.$textArea.val(oldTxt).css({display:"block",width:120,height:14,
				left:t.left+x-This.$workArea[0].parentNode.scrollLeft-32,
				top:t.top+y-This.$workArea[0].parentNode.scrollTop-76}).data("id",This.$focus).focus();
	...
	initGroup:function(width,height){
	  ...
	  this.$group.on("mousedown",{inthis:this},function(e){//绑定RESIZE功能以及移动功能
		...
		if(cursor!="move"){
			This.$ghost.css({display:"block",
				...
				top:This.$areaData[id].top+t.top-This.$workArea[0].parentNode.scrollTop+hack-76+"px",
				left:This.$areaData[id].left+t.left-This.$workArea[0].parentNode.scrollLeft+hack-12+"px",cursor:cursor});
		...
		document.onmousemove=function(e){
			...
			if(cursor!="move"){
				...
				This.$ghost.css({left:X+hack-12+"px",top:Y+hack-76+"px"});
			}
			isMove=true;
		};
		document.onmouseup=function(e){
	  ...
	  this.$group.on("dblclick",{inthis:this},function(e){
		...
		This.$textArea.val(oldTxt).css({display:"block",width:100,height:14,
			left:t.left+x-This.$workArea[0].parentNode.scrollLeft-32,
			top:t.top+y-This.$workArea[0].parentNode.scrollTop-76}).data("id",p.id).focus();
		This.$workArea.parent().one("mousedown",function(e){
			if(e.button==2)return false;
			if(This.$textArea.css("display")=="block"){
				This.setName(This.$textArea.data("id"),This.$textArea.val(),"area");
	...
	addNode:function(id,json){
		...
		if(json.type.indexOf(" round")<0){
			...
			if(!json.height||json.height<46)json.height=46;
	...
	initWorkForNode:function(){
			...
			document.onmousemove=function(e){
				...
				if(isMove&&This.$ghost.css("display")=="none"){
					This.$ghost.css({display:"block",
						...
						top:This.$nodeData[id].top+t.top-This.$workArea[0].parentNode.scrollTop+hack-76+"px",
						left:This.$nodeData[id].left+t.left-This.$workArea[0].parentNode.scrollLeft+hack-12+"px",cursor:"move"
					});
				}
		...
		this.$workArea.delegate(".GooFlow_item","mouseup",{inthis:this},function(e){
			...
			if(lineStart&&!This.$mpTo.data("p")){
				This.addLine(This.$id+"_line_"+This.$max,{from:lineStart.id,to:this.id,name:"line_"+This.$max});
				This.$max++;
			}
			else{
				if(lineStart){
		...
		this.$workArea.delegate(".GooFlow_item > .span","dblclick",{inthis:this},function(e){
			...
			This.$textArea.val(oldTxt).css({display:"block",height:$(this).height(),width:100,
				left:t.left+This.$nodeData[id].left-This.$workArea[0].parentNode.scrollLeft-24-32,
				top:t.top+This.$nodeData[id].top-This.$workArea[0].parentNode.scrollTop+26-76})
		...
		this.$workArea.delegate(".ico + td","dblclick",{inthis:this},function(e){
			...
			This.$textArea.val(oldTxt).css({display:"block",width:$(this).width()+24,height:$(this).height(),
				left:t.left+24+This.$nodeData[id].left-This.$workArea[0].parentNode.scrollLeft-32,
				top:t.top+2+This.$nodeData[id].top-This.$workArea[0].parentNode.scrollTop-76})
				.data("id",This.$focus).focus();
			This.$workArea.parent().one("mousedown",function(e){
				if(e.button==2)return false;
				This.setName(This.$textArea.data("id"),This.$textArea.val(),"node");
		...
		this.$workArea.delegate(".GooFlow_item > div > div[class!=rs_close]","mousedown",{inthis:this},function(e){
			...
			This.$ghost.css({display:"block",
				width:This.$nodeData[id].width-2+"px", height:This.$nodeData[id].height-2+"px",
				top:This.$nodeData[id].top+t.top-This.$workArea[0].parentNode.scrollTop+hack-76+"px",
				left:This.$nodeData[id].left+t.left-This.$workArea[0].parentNode.scrollLeft+hack-12+"px",cursor:cursor
			});
			var X,Y;
			X=ev.x-t.left+This.$workArea[0].parentNode.scrollLeft;
			Y=ev.y-t.top+This.$workArea[0].parentNode.scrollTop;
...
///////////以下为有关画线的方法
	...
	//统计一个节点的出口线条
	countOutLines:function(id){
		var data = this.exportData();
		var cnt = 0;
		for(var p in data.lines) {
			if(id == data.lines[p].from) {
				cnt++;
			}
		}
		return cnt;
	...
	//获取节点所有的线条出口
	getOutLines:function(id){
		var data = this.exportData();
		var slines = [];
		for(var p in data.lines) {
			if(id == data.lines[p].from) {
				slines.push(data.lines[p]);
			}
		}
		return slines;
	}
