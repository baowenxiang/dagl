 ...
 *       &lt;sequence>
 *         &lt;element ref="{http://www.saac.gov.cn/standards/ERM/encapsulation}LockedSignatureId"/>
...
@XmlRootElement(name = "LockSignature")
public class LockSignature {

    @XmlElement(name = "LockedSignatureId", required = true)
    @XmlIDREF
    @XmlSchemaType(name = "IDREF")
    protected ElecSignature lockedSignatureId;
     ...
     *     
     */
    public Object getLockedSignatureId() {
        return lockedSignatureId;
    }

    /**
     * 设置lockedSignatureId属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link Object }
     *     
     */
    public void setLockedSignatureId(ElecSignature value) {
        this.lockedSignatureId = value;
    }
