...
public class StringUtil {
     ...
     * 判断字符串是否为: "", null, "null"
     */
    public static boolean isEmpty(Object strValue){
        if (strValue == null || "".equals(String.valueOf(strValue).trim()) || "null".equals(strValue)) {
            return true;
        }
        return false;
    }
	...
	/**
	 * @Title toFirstChatUpperCase
	 * @Description 字符串首字母转为大写
	 * @author Pan Jilong
	 * @date 2016年11月25日
	 * @param str 字符串
	 * @return
	...
	/**
	 * @Title toFirstChatLowerCase
	 * @Description 字符串首字母转为小写
	 * @author Pan Jilong
	 * @date 2016年11月25日
	 * @param str 字符串
	 * @return
	...
	/**
	 * @Title underlineTosemi
	 * @Description 流程中参数中 "_"转化为 ":", 存入xml
	 * @author Pan Jilong
	 * @date 2016年11月27日
	 * @param str
	 * @return
