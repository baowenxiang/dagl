...
public class CustomArchiveServiceImpl implements CustomArchiveService {
    ...
    public List<BaseEntityInf> getEntitiesByPaging(String tablename, Map<String, Object> conditions, String othersql,
     ...
     // 设置查询条件
        ...
        if(pageSize<0){
        	params = generalDao.getObjectList(String.format(SELECTWHERE, entity.getTable(),condition.toString() ),0, -1, new Object[]{});
        }else{
        	
        	params = generalDao.getObjectList(String.format(SELECTPAGING, entity.getTable(),condition.toString() ,startRecord+pageSize,startRecord),
        			0, -1, new Object[]{});
        }
        for(Map<String, Object> param : params){
            entity = this.getTable(tablename).createEntity();
    ...
    @Override
    public List<BaseEntityInf> getLikeEntitiesByPaging(String tablename, Map<String, Object> conditions, String othersql,
            Integer startRecord, Integer pageSize) {
        DEntity entity = this.getTable(tablename).createEntity();
        List<BaseEntityInf> entities = new ArrayList<BaseEntityInf>();
        ...
        for(String key : conditions.keySet()){
            ...
            if(conditions.get(fieldname)==null){
                ...
                condition.append(String.format(stringlikeFormat, (String)conditions.get(fieldname))); 
            }
            i++;
        }
        condition.append(" ");
    ...
    @Override
    public List<BaseEntityInf> getEntitiesByConditions(String tablename, Map<String, Object> conditions, boolean like) {
        DEntity entity = this.getTable(tablename).createEntity();
        List<BaseEntityInf> entities = new ArrayList<BaseEntityInf>();
        ...
        if(like){
            // 设置查询条件
            entity.setQuery(conditions);
            List<Map<String, Object>> params = generalDao.getObjectList(String.format(SELECTALL, entity.getTable(), entity.getLikeQuery()),
                                             0, -1, new Object[]{});
            for(Map<String, Object> param : params){
                entity = this.getTable(tablename).createEntity();
                entity.setVals(param);
