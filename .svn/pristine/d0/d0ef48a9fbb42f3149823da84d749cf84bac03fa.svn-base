 ...
 */
@Controller
@RequestMapping(value = "/w/example/qttable")
public class QtBaseController extends BaseCtrlModel {
	...
	public ModelAndView init(HttpServletRequest request,@PathVariable("tablename") String tablename)throws ServiceException {
		...
		ModelAndView modelAndView = this.createNormalView("/web/kjCategory/qtList.vm");
        ...
        modelAndView.addObject("kjlb2", "kjlb2_4");
		return modelAndView;
	}
	...
	public String getList(String dtGridPager, HttpServletRequest request,@PathVariable("tablename") String tablename)throws ServiceException {
		...
		if(dataGridQuery.getAdvanceQueryConditions().size() > 0){
		    ...
		    sql = DField.DELFLAG + "='0' and kjlb2='kjlb2_4' and " + DField.ISARCHIVE + ">='3' " // 档案状态
		...
		String otherSql =  " AND kjlb2='kjlb2_4' AND "+DField.ISARCHIVE + ">='3' "+ authDepart(user) ;
